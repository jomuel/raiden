...
def run_app(
    ...
    contract_addresses_known = chain_id in ID_TO_NETWORK_CONFIG
    ...
    contract_addresses = ID_TO_NETWORK_CONFIG.get(chain_id, dict())
    ...
    try:
        chain_config = ID_TO_NETWORK_CONFIG.get(chain_id, {})
